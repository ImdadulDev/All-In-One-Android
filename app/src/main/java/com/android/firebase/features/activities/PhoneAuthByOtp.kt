package com.android.firebase.features.activities

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.android.firebase.features.R
...
//For more details
//https://github.com/firebase/quickstart-android/blob/8a3169ae7f75e38665a62c520ccf8960609ab815/auth/app/src/main/java/com/google/firebase/quickstart/auth/kotlin/PhoneAuthActivity.kt#L167-L167
class PhoneAuthByOtp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_phone_auth_by_otp)
        defineUI()
        ...
        sendOTPbtn.setOnClickListener {
            ...
            if (autoCompleteET.text != null && autoCompleteET.text.isNotEmpty())
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                    ...
                    this@PhoneAuthByOtp,        // Activity (for callback binding)
                    mCallback!!
                )
            else {
                hideKeyboard()
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    Toast.makeText(this@PhoneAuthByOtp, "Correct OTP", Toast.LENGTH_SHORT)
                        .show()
                    if (job!!.isActive)
                        job!!.cancel()
                    setPhoneNumber()
                } else {
                    Toast.makeText(this@PhoneAuthByOtp, "Incorrect OTP", Toast.LENGTH_SHORT)
                        .show()
                }
            }
    }
    ...
    private fun startFirebaseLogin() {
        ...
        mCallback = object : OnVerificationStateChangedCallbacks() {
            override fun onVerificationCompleted(phoneAuthCredential: PhoneAuthCredential) {
                Toast.makeText(this@PhoneAuthByOtp, "verification completed", Toast.LENGTH_SHORT)
                    .show()
            }

            override fun onVerificationFailed(e: FirebaseException) {
                Toast.makeText(this@PhoneAuthByOtp, "verification failed", Toast.LENGTH_SHORT).show()
            ...
            override fun onCodeSent(
                ...
                Toast.makeText(this@PhoneAuthByOtp, "Code Sent", Toast.LENGTH_SHORT).show()
